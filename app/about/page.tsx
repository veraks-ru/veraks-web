...
export const metadata: Metadata = {
  title: "О Вераксе — биржа репутации предсказателей",
  description:
    "Прогнозируйте исходы реальных событий словами, а не процентами. Точность становится публичным, накапливаемым трек-рекордом.",
};

/** Лендинг: что это и зачем. Главная страница — сама лента (app/page.tsx). */
    ...
    <footer className="border-t border-[color:var(--color-edge)]">
      <div className="mx-auto grid max-w-6xl gap-8 px-5 py-10 sm:grid-cols-[1.5fr_1fr_1fr] sm:px-8">
        ...
        <nav className="flex flex-col gap-2 text-sm text-haze">
          ...
          <Link href="/" className="hover:text-white">Лента</Link>
