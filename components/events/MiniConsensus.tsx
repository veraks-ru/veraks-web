...
/**
 * Компактное распределение мнений толпы по 5 градациям. Сводка раскрывается
 * только после закрытия приёма (анти-якорение, PRD §4.2): сервер отдаёт её
 * лишь для закрытых/разрешённых событий, на открытых её нет. mine —
 * подсветить столбец пользователя.
 */
