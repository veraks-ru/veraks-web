 ...
 * «втянутая» к центру (факт ближе к 50%, чем заявлено), — переуверенность;
 * «вытолкнутая» от центра (факт дальше от 50%) — недоуверенность. Знак нельзя
 * читать как «выше/ниже диагонали»: для «нет»-градаций он инвертируется.
 * Размер точки = объём прогнозов.
 */
