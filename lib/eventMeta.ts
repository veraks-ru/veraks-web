...
//
// ИНВАРИАНТ (анти-якорение, PRD §4.2): здесь не может появиться ничего про
// вероятности, проценты, консенсус толпы или число участников — ни для
// открытых событий, ни для закрытых. Карточка уходит наружу (соцсети,
// мессенджеры) и не должна подсказывать ответ. Только формулировка,
// категория, статус и даты.
